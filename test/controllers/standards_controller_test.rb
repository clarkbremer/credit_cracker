...
class StandardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standard" do
    assert_difference('Standard.count') do
      post standards_url, params: { standard: { benchmark: @standard.benchmark, code: @standard.code, example: @standard.example, field: @standard.field } }
    end
  ...
  test "should update standard" do
    patch standard_url(@standard), params: { standard: { benchmark: @standard.benchmark, code: @standard.code, example: @standard.example, field: @standard.field } }
